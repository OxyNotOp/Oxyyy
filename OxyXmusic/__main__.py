...
from OxyXmusic.Core.Clients.cli import LOG_CLIENT
from OxyXmusic.Core.PyTgCalls.OxyXmusic import (pytgcalls1, pytgcalls2, pytgcalls3,
...
from OxyXmusic.Utilities.inline import paginate_modules
...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! OxyXmusic Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("OfficialOxyXmusic")
            await ASS_CLI_1.join_chat("OxyXmusicSupport")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("OfficialOxyXmusic")
            await ASS_CLI_2.join_chat("OxyXmusicSupport")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("OfficialOxyXmusic")
            await ASS_CLI_3.join_chat("OxyXmusicSupport")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("OfficialOxyXmusic")
            await ASS_CLI_4.join_chat("OxyXmusicSupport")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("OfficialOxyXmusic")
            await ASS_CLI_5.join_chat("OxyXmusicSupport")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("OfficialOxyXmusic")
            await LOG_CLIENT.join_chat("OxyXmusicSupport")
        except:
            pass
    console.print(f"└[red] OxyXmusic Music Bot Boot Completed.")
    if STRING1 != "None":
